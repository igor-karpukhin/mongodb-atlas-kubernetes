...
func (r *AtlasReconciler) ResolveProject(ctx context.Context, sdkClient *admin.APIClient, pro project.ProjectReferrerObject, orgID string) (*project.Project, error) {
	...
	if pdr.ProjectRef != nil {
		project, err := r.projectFromKube(ctx, pro, orgID, projectsService)
		if err != nil {
...
func (r *AtlasReconciler) projectFromKube(ctx context.Context, pro project.ProjectReferrerObject, orgID string, service project.ProjectService) (*project.Project, error) {
